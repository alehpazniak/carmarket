package com.carmarket.auction.security;
...
/**
 * Trusts the gateway's signed identity headers (X-User-Id / X-Gateway-Signature) instead of
 * re-validating a JWT — the gateway already did that. Mirrors car-service's filter of the same name.
 */
@Slf4j
@Component
